...
def train(data_folder: pathlib.Path,
    ...
    class_weights_train_murmur = torch.tensor([1.0, 10.0])
    class_weights_train_outcome = torch.tensor([1.0, 10.0])
    ...
    loss_df = pd.DataFrame({'Epoch': range(1, epoch + 2),
                                  'Train Loss': train_loss_list,
                                    ...
                                    'Train Outcome Loss': train_outcome_loss_list,
                                    'Val Frame Loss': val_frame_loss_list,
                                    'Val Murmur Loss': val_murmur_loss_list,
                                    'Val Outcome Loss': val_outcome_loss_list,
                                    })
